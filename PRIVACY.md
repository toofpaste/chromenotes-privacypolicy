# Simple Notes 98 Privacy Policy
...
- **Images** that you paste, upload, or annotate within a note.
...
All data is stored locally using the Chrome Extensions `chrome.storage.local` API. The extension does not use remote databases,
 cloud services, or analytics providers. Because everything resides within your browser profile, uninstalling the extension or 
clearing browser storage will delete your notes.

## How data is used
The extension only reads your stored data to render notes, drawings, images, and preferences within the popup, overlay, and opti
ons page. Data is never transmitted to external servers or shared with third parties.

## Network access
Simple Notes 98 does not make network requests for note content, preferences, or usage analytics. The extension only loads bundled
 assets and optional icon files that you supply.

## Data control
You can delete notes, folders, images, and drawings at any time from within the interface. Removing the extension from Chrome or
